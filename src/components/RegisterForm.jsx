                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        helperText={errors.phoneNumber?.message || errors.countryCode?.message}
                        InputProps={{
                          startAdornment: (
                            <InputAdornment position="start">
                                ...
                                render={({ field: countryField }) => (
                                  ...
                                  >
                                    {countryCodes.map((country, index) => (
                                      <MenuItem key={`${country.code}-${country.country}-${index}`} value={country.code}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                          <span style={{ fontSize: '1.4rem' }}>{country.flag}</span>
                                          <span style={{ fontWeight: 500 }}>{country.code}</span>
                                          <span style={{ fontSize: '0.85rem', color: '#666' }}>{country.country}</span>
                                        </Box>
                                      </MenuItem>
                                    ))}
                                  </TextField>
